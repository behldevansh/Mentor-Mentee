  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        Connect <br /> Mentor and Mentee <br /> anywhere in the World
      </motion.h1>
    </LampContainer>
  );
}
...
export const LampContainer = ({ children, className = "" }) => {
  return (
    <div
      className={`relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-white w-full rounded-md z-0 ${className}`}>
